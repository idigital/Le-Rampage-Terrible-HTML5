function BoundingBox(gameObject, x, y, width, height)
{
	...
	{
		if(target.CheckForPointCollision(this.m_topLeft.m_dx, this.m_topLeft.m_dy) == true
			|| target.CheckForPointCollision(this.m_topRight.m_dx, this.m_topRight.m_dy) == true
			|| target.CheckForPointCollision(this.m_bottomLeft.m_dx, this.m_bottomLeft.m_dy) == true
			|| target.CheckForPointCollision(this.m_bottomRight.m_dx, this.m_bottomRight.m_dy) == true)
		{
			return true;
		}
	...
	this.GetCollisionDetails = function(target)
	{
		...
		if( this.m_bottom < target.m_top && this.m_bottom > target.m_bottom
			...
			(
				...
				||
				(this.m_left < target.m_right && this.m_left > (target.m_left - this.m_width))
			)
		)
		{
